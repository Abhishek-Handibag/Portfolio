        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/3 mb-10 md:mb-0 flex justify-center">
            <div className="relative">
              <div className="w-64 h-64 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 p-1">
                <img  src={profileImage} alt="Abhishek Handibag" className="w-full h-full rounded-full object-cover border-4 border-gray-800" />
              </div>
            </div>
          </div>
          <div className="md:w-2/3 md:pl-12">
            ...
            <p className="text-gray-300 mb-6">
              I'm a passionate AI Engineer with strong backend and ML development experience. I specialize in building intelligent systems using Generative AI, LLM integrations, vector databases, and computer vision.
            </p>
            {/* ...existing about text... */}
